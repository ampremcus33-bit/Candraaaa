      ...
      >
        ...
        <div className="relative">
          <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_40px_rgba(120,119,198,0.3)] transform transition-all duration-700 group-hover:scale-105">
            ...
            {/* Foto yang berganti otomatis */}
            <img
              src={images[index]}
              alt="Profile"
              className="w-full h-full object-cover transition-all duration-700 ease-in-out group-hover:scale-110 group-hover:rotate-2"
              loading="lazy"
            />
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
            I’m a technology enthusiast with a strong interest in front-end development, network configuration, robotics, and digital photo editing. I enjoy exploring how different fields of technology can connect to create innovative and efficient solutions.
            </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https:https://drive.google.com/file/d/18FcjnBdpPUm8aUrby8MOAUeIZiv_EOPh/view?usp=drivesdk" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
