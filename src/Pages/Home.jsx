...
import { Linkedin, Mail, ExternalLink, Instagram, Sparkles, Phone } from "lucide-react"
...
const WORDS = ["Web Development", "Tech Enthusiast","Networking & Robotik", "Photographer"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Phone, link: "https://wa.me/6282140646954" },
  { icon: Instagram, link: "https://www.instagram.com/cndrnvrdie?igsh=MXJxcWNqNjRycWg3OQ==" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Building Website responsive, Robotik, Photo editor, and Configuring a WiFi network
                </p>
